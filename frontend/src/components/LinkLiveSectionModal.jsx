                ...
                {filteredLiveSections.map(ls => {
                  ...
                  return (
                    ...
                    >
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                              effectiveStatus === 'active' ? 'bg-olive-10 text-olive-dark' : 'bg-gray-100 text-gray-600'
                            }`}>
                              {effectiveStatus}
                            </span>
                          </div>
                          ...
                          <motion.button
                            ...
                            className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all flex-shrink-0 ${
                              isLinked
                                ...
                                : 'bg-gradient-to-r from-olive to-olive-dark text-white shadow-md hover:shadow-lg'
                            } disabled:opacity-50`}
                          >
                      ...
                      {isLinked && (
                        <div className="flex items-center gap-2 mt-3 pt-3 border-t border-olive-20">
                          <svg className="w-4 h-4 text-olive" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          </svg>
                          <span className="text-xs text-olive-dark font-medium">Linked to this offer</span>
                        </div>
                      )}
                    </div>
                  );
