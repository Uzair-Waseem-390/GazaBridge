// frontend/src/pages/Posts.jsx - Updated with edit functionality and proper permissions
...
export default function Posts() {
  ...
  const handleDelete = async (id) => {
    if (window.confirm(`Are you sure you want to delete this ${activeTab === 'offers' ? 'offer' : 'request'}?`)) {
      try {
        if (activeTab === 'offers') {
